...
//#define USE_CORE				/* Uncomment this macro to process all the 12 channels using core */
#define USE_ACC					/* Uncomment this macro to process all the 12 channels using accelerator */
